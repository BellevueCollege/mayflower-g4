<?php
/*
Plugin Name: List Category Posts - Template 'Image Heading Content'
...
while ( have_posts() ) :
	...
	if ( ! $this->check_show_protected( $post ) ) {
		continue;
	}

	// Start a List Item for each post:
	$lcp_display_output .= $this->open_inner_tag( $post, 'div' );

	// Post Thumbnail
	$lcp_display_output .= '<a href="'. get_permalink() . '">' . $this->get_thumbnail( $post ) . '</a>';
